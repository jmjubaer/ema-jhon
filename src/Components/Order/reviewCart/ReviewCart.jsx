...
const ReviewCart = ({ product,handleRemoveCart }) => {
  ...
  return (
    <div className="p-3 pr-5 border rounded-md my-5 flex justify-between items-center">
        ...
        <button onClick={() => handleRemoveCart(id)} className="text-3xl w-14 h-14 text-[#EB5757] bg-[rgba(235,87,87,0.30)] rounded-full"><FontAwesomeIcon icon={faTrashCan}/></button>
    </div>
  );
};
