...
const Cart = ({cart}) => {
    ...
    return (
        <div>
                ...
                <h3 className='text-lg mt-4'>Selected Items: {cart.length}</h3>
                ...
                <button className='block p-3 w-full text-white bg-[#FF3030] active:bg-[#FF9900] rounded-lg mt-14'>Clear Cart <FontAwesomeIcon icon={faTrashCan}/></button>
