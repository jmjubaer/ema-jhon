...
const Cart = ({cart}) => {
    ...
    return (
        <div>
                ...
                <button onClick={handleNavigate}  className='block p-3 w-full text-white bg-[#FF9900] active:bg-[#FF3030] rounded-lg mt-4'>Review Order <FontAwesomeIcon icon={faArrowRight} /> </button>
        </div>
    );
};
